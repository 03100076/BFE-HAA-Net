...
#from .haa import SpaceAttDown as HAANet # change SpaceAttDown
#from .haa import SpaceAttDownPoolCat as HAANet
#from .haa import SpaceAttDownPoolSum as HAANet
#from .haa import CBAM as HAANet
#from .haa import F1 as HAANet
...
class SingleBiFPN_v3(Backbone):
    ...
    def __init__(
        ...
        """
        super(SingleBiFPN_v3, self).__init__()
        ...
        for fnode in self.nodes:
            ...
            ## add HAANet
            if top_down_flag:
                name = "haa_f{}".format(feat_level)
                self.add_module(name, HAANet(out_channels))
            if feat_level == 0:
                top_down_flag = False
    ...
    def forward(self, feats):
        ...
        for fnode in self.nodes:
            ...
            ## HAANet forward: feature update
            if feat_level == 0:
                curr_num = len(feats)
                for level in range(num_levels):
                    name = "haa_f{}".format(level)
...
class BiFPN_v3(Backbone):
    ...
    def __init__(
        ...
        for i in range(num_repeats):
            ...
            self.repeated_bifpn.append(SingleBiFPN_v3(
...
def build_fcos_resnet_bifpn_backbone_v3(cfg, input_shape: ShapeSpec):
    """
    Args:
    ...
    backbone = BiFPN_v3(
        ...
        post_process='haa' # 设置这一项，增加最后的映射
    )
    return backbone
