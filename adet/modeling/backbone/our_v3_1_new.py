...
class SingleBiFPN_v3_1(Backbone):
    """
    ...
    def __init__(
        ...
        """
        super(SingleBiFPN_v3_1, self).__init__()
        ...
        for fnode in self.nodes:
            ...
            ## add SpaceAtt
            if top_down_flag:
                name = "SpaceAtt_f{}".format(feat_level)
                self.add_module(name, SpaceAtt())
            if feat_level == 0:
                top_down_flag = False
    ...
    def forward(self, feats):
        ...
        for fnode in self.nodes:
            ...
            ## SpaceAtt forward: feature update
            if feat_level == 0:
                curr_num = len(feats)
                for level in range(num_levels):
                    name = "SpaceAtt_f{}".format(level)
...
class BiFPN_v3_1(Backbone):
    ...
    def __init__(
        ...
        Args:
            ...
            norm (str): the normalization to use.
        """
        super(BiFPN_v3_1, self).__init__()
        ...
        for i in range(num_repeats):
            ...
            self.repeated_bifpn.append(SingleBiFPN_v3_1(
...
def build_fcos_resnet_bifpn_backbone_v3_1(cfg, input_shape: ShapeSpec):
    """
    Args:
