...
class SingleBiFPN_v1(Backbone):
    ...
    def __init__(
        ...
        """
        super(SingleBiFPN_v1, self).__init__()
...
class BiFPN_v1(Backbone):
    ...
    def __init__(
        ...
        for i in range(num_repeats):
            ...
            self.repeated_bifpn.append(SingleBiFPN_v1(
...
def build_fcos_resnet_bifpn_backbone_v1(cfg, input_shape: ShapeSpec):
    """
    Args:
