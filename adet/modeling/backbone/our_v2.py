...
class SingleBiFPN_v2(Backbone):
    ...
    def __init__(
        ...
        """
        super(SingleBiFPN_v2, self).__init__()
        ...
        self.nodes = [ {'feat_level': 2, 'inputs_offsets': [2, 3]},
                        ...
                        {'feat_level': 2, 'inputs_offsets': [4, 7]},
                        {'feat_level': 3, 'inputs_offsets': [3, 8]}]
...
class BiFPN_v2(Backbone):
    ...
    def __init__(
        ...
        for i in range(num_repeats):
            ...
            self.repeated_bifpn.append(SingleBiFPN_v2(
...
def build_fcos_resnet_bifpn_backbone_v2(cfg, input_shape: ShapeSpec):
    """
    Args:
