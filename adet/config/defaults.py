...
_C.MODEL.FCOS.NUM_CLASSES = 3  #XDUAV=6 UAVDT=3 Stanford=3
...
_C.MODEL.NOFPN = CN()
# Names of the input feature maps to be used by NOFPN
# They must have contiguous power of 2 strides
# e.g., ["res2", "res3", "res4", "res5"]
_C.MODEL.NOFPN.IN_FEATURES = ["res3", "res4", "res5"]
_C.MODEL.NOFPN.OUT_CHANNELS = 256
_C.MODEL.NOFPN.NUM_REPEATS = 1
