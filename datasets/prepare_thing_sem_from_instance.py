...
if __name__ == "__main__":
    ...
    if args.dataset_name == "coco":    
        ...
        split_name = 'train'             ####train2017####
        annotation_name = annotations/uavdt_{}_cocostyle.json
    else:
        thing_id_to_contiguous_id = {1: 0}
        split_name = 'train'
        annotation_name = "annotations/{}_person.json"
    for s in ["train"]:              ####train2017####
        create_coco_semantic_from_instance(
            os.path.join(dataset_dir, "annotations/uavdt_{}_cocostyle.json".format(s)),  
